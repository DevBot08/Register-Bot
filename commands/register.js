...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        if(!args.length) return message.channel.send(`${message.author} **SUPPORT**,***Tulis nama lu Brey.***`);
        ...
        try {
            ...
            private.send(`${message.author} **Berhasil**, ***Lu sudah ${TAG} di ${message.guild.name}.***`);
        } catch(error) {
            console.error(error); 
        }
    },
